...
export class MQService implements TransportService {
    ...
    public configure(config?: ConfigInterface): void {
    ...
    public publishTopic(topic, message?: string) {
    ...
    public on_message = (...args: any[]) => {
        ...
        console.log("on_message Topic:", topic);
        console.log("on_message MSG:", message);
        console.log("on_message Packet MessageID:", packet.messageId);
